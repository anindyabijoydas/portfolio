...
* **Journal Papers**
  * **Anindya Bijoy Das** and Aditya Ramamoorthy, [''**Coded sparse matrix computation schemes that leverage partial stragglers**'',](https://ieeexplore.ieee.org/document/9717254) in IEEE Transactions on Information Theory, to vol. 68, no. 6, pp. 4156-4181, 2022. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/v9sh9ozqe37afw6/coded_sp.pdf?dl=0) <br />
...
* **Conference Papers**
   * **Anindya Bijoy Das** and Aditya Ramamoorthy, [''**A Unified Treatment of Partial Stragglers and Sparse Matrices in Coded Matrix Computation**''](https://arxiv.org/abs/2109.12070) in IEEE Information Theory Workshop (ITW), 2021, pp. 1-6. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/b8mf72b0jzfo3y4/class.pdf?dl=0) [<span style="color:purple">**slides**.</span>](https://www.dropbox.com/s/wowfbn9dnygnp6h/class_presentation.pdf?dl=0)
   * **Anindya Bijoy Das** and Aditya Ramamoorthy, [''**Coded sparse matrix computation schemes that leverage partial stragglers**''](https://ieeexplore.ieee.org/abstract/document/9518059) in IEEE International Symposium on Information Theory (ISIT), 2021, pp. 1570-1575. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/hkz63g3te7zfftr/coded_sparse.pdf?dl=0) [<span style="color:purple">**slides**.</span>](https://www.dropbox.com/s/6v6sn0urfh8ique/sparse_presentaion.pdf?dl=0)
   * **Anindya Bijoy Das**, Aditya Ramamoorthy and Namrata Vaswani, [''**Efficient and Robust Distributed Matrix Computations via Convolutional Coding**''](https://ieeexplore.ieee.org/abstract/document/9518059) in IEEE International Symposium on Information Theory (ISIT), 2021, pp. 1724-1729. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/xxfxu4otrqjs9yu/conv_code.pdf?dl=0) [<span style="color:purple">**slides**.</span>](https://www.dropbox.com/s/gy828wi4yuf7wrt/ittrans_presentation.pdf?dl=0)
   ...
   * **Anindya Bijoy Das**, Aditya Ramamoorthy and Li Tang, [''**C3LES : Codes for Coded Computation that Leverage Stragglers**'',](https://ieeexplore.ieee.org/abstract/document/8613321) in IEEE Information Theory Workshop (ITW), 2018, pp. 1-5. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/rc3bd70vovbshnu/cyclic.pdf?dl=0)

* **Under Review**
   * **Anindya Bijoy Das** and Aditya Ramamoorthy, [''**A Unified Treatment of Partial Stragglers and Sparse Matrices in Coded Matrix Computation**''](https://arxiv.org/abs/2109.12070) under review. [<span style="color:blue">**paper**.</span>](https://www.dropbox.com/s/7f2c76dtqas4k07/jsait.pdf?dl=0) 
<br /> <br />
